...
(function (FluffyPong_Img) {
    class WallRightHole extends FluffyPong_Img.Wall {
        ...
        draw() {
            ...
            FluffyPong_Img.holeRightHeight1 = (FluffyPong_Img.fluffyHeight * 1.5) + Math.random() * (FluffyPong_Img.fluffyHeight / 2);
            ...
            FluffyPong_Img.holeRightHeight2 = (FluffyPong_Img.fluffyHeight * 1.5) + Math.random() * (FluffyPong_Img.fluffyHeight / 2);
