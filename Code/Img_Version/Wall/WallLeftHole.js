...
(function (FluffyPong_Img) {
    class WallLeftHole extends FluffyPong_Img.Wall {
        ...
        draw() {
            ...
            FluffyPong_Img.holeLeftHeight1 = (FluffyPong_Img.fluffyHeight * 1.5) + Math.random() * (FluffyPong_Img.fluffyHeight / 2);
            ...
            FluffyPong_Img.holeLeftHeight2 = (FluffyPong_Img.fluffyHeight * 1.5) + Math.random() * (FluffyPong_Img.fluffyHeight / 2);
