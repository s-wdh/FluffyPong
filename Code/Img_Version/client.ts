                ...
                if (namesent == true) {
                    ...
                    switch (fluffy.direction) {
                        case "top":
                            ...
                            break;
                        case "right":
                            x = (canvasWidth - borderWidth - fluffyWidth - 1);
                            y = fluffy.position;
                            break;
                        case "bottom":
                            x = fluffy.position;
                            y = (canvasHeight - borderWidth - fluffyHeight - 1);
                            break;
                        case "left":
                            x = borderWidth + 1;
                            y = fluffy.position;
                    ...
                    if (x > canvasWidth - fluffyWidth) { x = (canvasWidth / 2); }
                    if (y > canvasHeight - fluffyHeight) { y = (canvasHeight / 2); }
